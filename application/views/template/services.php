				...
				<?php foreach($rutes as $row): ?>
					<div class="container">
						...
						<p class="section-subtitle">
							<i><?php echo $row->rute_from; ?></i> To <i><?php echo $row->rute_to; ?></i>
						</p>
						<table class="table table-hover table-responsive text-center" style="color:black;">
							...
							<tbody>
								<tr>
									...
									<td class="center"><?php echo $row->depart_at; ?><br><?php echo $row->date; ?></td>
									<td class="center"><?php echo $row->arrival_at; ?><br><?php echo $row->date; ?></td>
									<td class="center"><?php echo $row->rute_from; ?></td>
									<td class="center"><?php echo $row->rute_to; ?></td>
									<td class="center"><?php echo $row->price; ?></td>
									<td class="center"><a href="<?php echo base_url('template/pesan/'.$row->transportation_id.'/'.$row->id); ?>" class="btn btn-primary center-block">Pesan</a></td>
								</tr>
							</tbody>
						</table>
					</div> <!-- /.container -->
