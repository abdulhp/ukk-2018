...
<head>
	...
	<link rel="stylesheet" href="<?php echo base_url();?>assets/landing/css/flexslider.css" type="text/css">
		  ...
		  <body>
		  	<nav class="navbar navbar-default navbar-fixed-top">
		  		<div class="container">
		  			...
		  			<div class="navbar-header">
		  				...
		  				<a class="navbar-brand" href="index.html" title="HOME"><i class="ion-paper-airplane"></i> <b><i>A</i>IR</b> <span>Transport</span></a>
		  			</div> <!-- /.navbar-header -->
		  			...
		  			<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
		  				<ul class="nav navbar-nav navbar-right">
		  					...
		  					<li><a href="<?php echo base_url('template/about'); ?>">about</a></li>
		  					<li><a href="<?php echo base_url('template/services'); ?>">services</a></li>
		  					<li><a href="<?php echo base_url('template/contact'); ?>">contact</a></li>
		  				</ul> <!-- /.nav -->
		  			</div><!-- /.navbar-collapse -->
		  		</div><!-- /.container -->
		  	</nav>
			...
			<div id="header">
				<div class="flexslider">
					<ul class="slides">
						<li class="slider-item" style="background-image: url('<?php echo base_url();?>assets/landing/images/item-1.png')">
						...
						<li class="slider-item" style="background-image: url('<?php echo base_url();?>assets/landing/images/item-2.png')">
							<div class="intro">
								<div class="inner-intro">
									<h1 class="header-title">
			...
			<section class="tour section-wrapper container">
				...
				<div class="row">
					...
					<div class="col-md-3 col-sm-6">
						<form role="form" method="get" class="form-dropdown" action="<?php echo base_url('template/search');?>">
							<div class="form-group">
								<label for="sel1">Departure</label>
								<select class="form-control border-radius" id="sel1" name="departure">
									<?php 
									$x=""; 
									foreach($rute as $r){
										if($r->rute_from !== $x){
						...
						<div class="col-md-3 col-sm-6">
							<div class="input-group">
								<select class="form-control border-radius" id="sel1" name="destination">
									<?php 
									$y=""; 
									foreach($rute as $r){
										if($r->rute_to !== $y){
						...
						<div class="col-md-3 col-sm-6">
							<div class="input-group">
								<input type="date" class="form-control border-radius" name="departat" placeholder="Depart at">
							</div>
						</div>
						<div class="col-md-3 col-sm-6">
							<input type="submit" value="Search" class="btn btn-default border-radius custom-button">
						</div>
					</form>
				</div>
			</section> <!-- /.tour -->
		  	...
		  	<section class="visit section-wrapper">
		  		<div class="container">
		  			...
		  			<div class="owl-carousel visit-carousel" id="">
		  				<div class="item">
		  					<img src="<?php echo base_url();?>assets/landing/images/visit-1.png" alt="visit-image" class="img-responsive visit-item">
		  				</div>
		  				<div class="item">
		  					<img src="<?php echo base_url();?>assets/landing/images/visit-2.png" alt="visit-image" class="img-responsive visit-item">
		  				</div>
		  				<div class="item">
		  					<img src="<?php echo base_url();?>assets/landing/images/visit-3.png" alt="visit-image" class="img-responsive visit-item">
		  				</div>
		  				<div class="item">
		  					<img src="<?php echo base_url();?>assets/landing/images/visit-1.png" alt="visit-image" class="img-responsive visit-item">
		  				</div>
