...
<head>
  ...
  <title>AIRTransport | Log in</title>
...
<div class="login-box">
  <div class="login-logo">
    <a href="<?php echo base_url();?>"><b><i>A</i>IR</b>Transport <i class="fa fa-plane"></i></a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    <p class="login-box-msg">Sign in to start the journey</p>
